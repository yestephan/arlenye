...
- **Global scope**: `/Users/stephanye/Documents/arlenye/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/stephanye/Documents/arlenye/.claude/notes/`)
...
2. Glob `/Users/stephanye/Documents/arlenye/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/stephanye/Documents/arlenye/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/stephanye/Documents/arlenye/.claude/notes/` — works in any directory
